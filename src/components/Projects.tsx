...
const Cards = () => {
  return (
    <div id="projects" className="w-full py-16 bg-[#240046]">
      ...
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8 mt-8">
        <div className="w-full shadow-xl bg-[#3c096c] flex flex-col p-6 my-4 rounded-lg hover:scale-105 duration-300">
          <img
            ...
            alt="Hexagon"
          />
          <h2 className="text-2xl font-bold text-center py-8 text-white">Smart Build</h2>
          <div className="text-center font-medium text-white">
            <p className="py-2 border-b border-gray-400 mx-8 mt-8">Lorem Ipsum is simply </p>
          ...
          <button className="bg-[#00df9a] w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3 text-[#240046] hover:bg-[#00b77e] transition duration-300">
            Visit
          </button>
        </div>
        <div className="w-full shadow-xl bg-[#3c096c] flex flex-col p-6 md:my-0 my-8 rounded-lg hover:scale-105 duration-300">
          <img
            className="w-20 h-20 mx-auto mt-[-3rem] bg-transparent rounded-full shadow-md"
            src={"images/fsensina.png"}
            alt="Fs Ensina"
          />
          <h2 className="text-2xl font-bold text-center py-8 text-white">Fs Ensina</h2>
          <div className="text-center font-medium text-white">
            <p className="py-2 border-b border-gray-400 mx-8 mt-8">ENSINA by FS</p>
            <p className="py-2 border-b border-gray-400 mx-8">
        ...
        <div className="w-full shadow-xl bg-[#3c096c] flex flex-col p-6 my-4 rounded-lg hover:scale-105 duration-300">
          <img
            ...
            alt="Triple"
          />
          <h2 className="text-2xl font-bold text-center py-8 text-white">App Development</h2>
          ...
          <div className="text-center font-medium text-white">
            ...
            <p className="py-2 border-b border-gray-400 mx-8">Lorem Ipsum is simply dumm.</p>
          </div>
          <button className="bg-[#00df9a] w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3 text-[#240046] hover:bg-[#00b77e] transition duration-300">
            Start Trial
          </button>
